                ...
                <div className="detail-col">
                    <section className="detail-section card">
                        ...
                        <div className="info-list">
                            <div className="info-item">
                                ...
                                <span className="value">{nurse.fullName}</span>
                            </div>
                            <div className="info-item">
                            ...
                            <div className="info-item">
                                ...
                                <span className="value">{nurse.phone}</span>
                            </div>
                            <div className="info-item">
                            ...
                            <div className="info-item">
                                <span className="label">Bán kính phục vụ</span>
                                <span className="value">{nurse.serviceRadiusKm} km</span>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="detail-section card">
                        ...
                        <div className="bio-box">
                            {nurse.bio || 'Chưa có thông tin giới thiệu.'}
                        </div>
                    </section>
                </div>
                            ...
                            {nurse.documents && nurse.documents.length > 0 ? (
                                nurse.documents.map((doc) => (
                                    <div key={doc.id} className="doc-admin-item">
                                        <div className="doc-icon-box"><FileIcon /></div>
                                        <div className="doc-details">
                                            <span className="doc-type">{doc.type.replace('_', ' ').toUpperCase()}</span>
                                            <a href={doc.fileUrl} target="_blank" rel="noreferrer" className="view-btn">Xem bản chính</a>
                                        </div>
