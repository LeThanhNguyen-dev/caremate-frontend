                        ...
                        >
                            ...
                            <div className="mt-12 grid gap-4">
                                <button
                                    ...
                                    className="w-full py-5 rounded-xl bg-slate-900 text-white text-[10px] font-black uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-brand transition-all shadow-xl shadow-slate-900/10 active:scale-95"
                                >
