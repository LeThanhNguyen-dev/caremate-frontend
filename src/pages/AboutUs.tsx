        ...
        <div className="pb-20">
            ...
            <section className="mx-auto max-w-7xl px-6 lg:px-8 -mt-16 relative z-20">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        >
                            <div className="h-12 w-12 rounded-2xl bg-slate-900/5 flex items-center justify-center text-white mb-6">
            ...
            <section className="mx-auto max-w-7xl px-6 lg:px-8 mt-32 grid lg:grid-cols-2 gap-16 items-start">
                ...
                >
                    ...
                    <div className="aspect-square w-full rounded-2xl bg-slate-100 overflow-hidden shadow-inner border-8 border-white relative">
                ...
                >
                    <div className="flex items-center gap-4 mb-10">
                        <div className="h-12 w-12 rounded-2xl bg-slate-900 text-white flex items-center justify-center shadow-lg shadow-brand/20">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button 
                            type="submit" 
                            disabled={sending}
                            className="btn-primary w-full py-4 rounded-2xl text-[10px] font-extrabold uppercase tracking-widest flex items-center justify-center gap-3"
                        >
                ...
                <div className="grid md:grid-cols-3 gap-12">
                    {[
                        ...
                        <div key={i} className="text-center">
                            <div className="h-16 w-16 rounded-2xl bg-slate-50 text-[#0F172A] flex items-center justify-center mx-auto mb-6 shadow-sm">
