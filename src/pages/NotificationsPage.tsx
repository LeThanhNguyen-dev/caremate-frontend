            ...
            <div className="max-w-5xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="relative flex flex-col md:flex-row md:items-end justify-between gap-8">
                        <div>
                            ...
                            <h1 className="text-5xl font-black text-slate-900 tracking-tight mb-4">
                                Trung tâm <span className="text-brand">tin nhắn</span>
                            </h1>
                ...
                <AnimatePresence mode="wait">
                    {filteredItems.length === 0 ? (
                        ...
                        >
                            <div className="h-32 w-32 rounded-xl bg-slate-50 flex items-center justify-center mx-auto mb-10 group-hover:scale-110 transition-transform">
                                <InboxStackIcon className="h-14 w-14 text-slate-200" />
                            </div>
                            <h3 className="text-2xl font-black text-slate-900 mb-3 tracking-tight">Hộp thư đang trống</h3>
                            <p className="text-slate-400 text-lg font-medium max-w-sm mx-auto">
                                Tuyệt vời! Bạn đã cập nhật hết tất cả các thông báo từ CareMate.
                            </p>
                        </motion.div>
                    ) : (
                        <motion.div 
                                ...
                                >
                                    <div className="relative z-10 flex items-start justify-between gap-8">
                                        <div className="flex gap-8">
                                            <div className={`h-16 w-16 rounded-xl flex items-center justify-center flex-none shadow-sm transition-all duration-500 group-hover:scale-110 ${
                                                !n.isRead 
